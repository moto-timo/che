 ...
 * @author Oleksii Orel
 */
public class SshCategoryPresenter implements CategoryPage, SshView.ActionDelegate {
    ...
    private final SshMachineTargetFactory     targetFactory;
    ...
    public SshCategoryPresenter(SshView sshView,
        ...
        this.targetFactory = new SshMachineTargetFactory(machineLocale, sshView, this);
    ...
    private boolean isTargetNameExist(String targetName) {
        return this.delegate == null || this.delegate.isTargetNameExist(targetName);
    }
    ...
    private MachineDto getMachineByName(String machineName) {
        ...
        return this.delegate.getMachineByName(machineName);
    }
    ...
    private void updateTargets(String preselectTargetName) {
        ...
        this.delegate.updateTargets(preselectTargetName);
    }

    public void setSelectedTarget(SshMachineTarget selectedTarget) {
        this.selectedTarget = selectedTarget;
    }

    private boolean selectTarget(Target target) {
        if (this.delegate == null) {
            return false;
        }

        this.delegate.selectTarget(target);
        this.updateButtons();
