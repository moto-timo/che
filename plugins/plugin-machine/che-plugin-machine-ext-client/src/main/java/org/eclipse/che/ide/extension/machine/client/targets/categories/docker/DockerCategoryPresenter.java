 ...
 * @author Oleksii Orel
 */
public class DockerCategoryPresenter implements CategoryPage, DockerView.ActionDelegate {
    ...
    private final DockerMachineTargetFactory  targetFactory;
    ...
    public DockerCategoryPresenter(DockerView dockerView,
        ...
        this.targetFactory = new DockerMachineTargetFactory(machineLocale, dockerView, this);
