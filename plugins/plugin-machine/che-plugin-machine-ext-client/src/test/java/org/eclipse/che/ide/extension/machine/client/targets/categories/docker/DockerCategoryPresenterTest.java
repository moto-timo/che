...
public class DockerCategoryPresenterTest {
    ...
    public void testOnDeleteTarget() throws Exception {
        ...
        when(delegate.getMachineByName(deletingTargetName)).thenReturn(machine);
        ...
        verify(delegate).getMachineByName(deletingTargetName);
    ...
    public void testGetTargetFactory() throws Exception {
        ...
        assertTrue(factory instanceof DockerMachineTargetFactory);
    }
