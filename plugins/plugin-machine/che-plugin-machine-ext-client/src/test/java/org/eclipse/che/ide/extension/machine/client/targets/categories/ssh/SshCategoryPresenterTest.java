...
public class SshCategoryPresenterTest {
    ...
    public void setUp() {
        ...
        arbitraryCategoryPresenter.setDelegate(delegate);
    }
    ...
    public void testOnDeleteTarget() throws Exception {
        ...
        arbitraryCategoryPresenter.onDeleteTarget(target);
        ...
        verify(delegate).updateTargets(null);
    }
    ...
    public void testOnCancelClicked() throws Exception {
        ...
        arbitraryCategoryPresenter.setSelectedTarget(target);

        arbitraryCategoryPresenter.onCancelClicked();

        verify(target).onRestore();
        verify(target).setDirty(false);
        verify(target).onSelect();
    }
    ...
    public void testConnectButtonTitle() throws Exception {
        ...
        verify(sshView).setConnectButtonText(connectButtonTitle);
    }
    ...
    public void testOnTargetNameChangeFail() throws Exception {
        ...
        verify(sshView, never()).unmarkTargetName();
    }
    ...
    public void testOnTargetNameChanged() throws Exception {
        ...
        verify(target).setDirty(true);
        verify(sshView).unmarkTargetName();
    }

    @Test
    public void testGetTargetFactory() throws Exception {
        TargetFactory factory = arbitraryCategoryPresenter.getTargetFactory();

        assertTrue(factory instanceof SshMachineTargetFactory);
    }
